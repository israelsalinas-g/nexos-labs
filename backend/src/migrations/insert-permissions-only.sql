-- ============================================================================
-- INSERT DE PERMISOS - SCRIPT OPTIMIZADO
-- ============================================================================
-- Ejecutar DESPUÉS de haber insertado los roles y usuarios
-- Los IDs de roles CONFIRMADOS son:
...
SELECT r.name as rol, COUNT(*) as cantidad_permisos
FROM permissions p
...
SELECT '---' as separador;
SELECT 'Detalle de permisos:' as detalle;
